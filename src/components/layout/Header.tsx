		...
		<header className="bg-white dark:bg-gray-900 relative z-20">
			<nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
				...
				<div className="flex items-center gap-3 lg:flex-1">
					<Link href="/dashboard" className="flex items-center -m-1.5 p-1.5">
						<Image src={Logo} alt="테니스랭크 로고" className="w-8 h-8" />
						<span className="ml-2 text-2xl font-extrabold text-gray-900 dark:text-white tracking-wide">
							XSS
						</span>
					</Link>
				</div>
